/**
 * Load and display news from JSON files
 * News items are loaded from data/news/ directory
 */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  fetch(manifestPath, { cache: 'no-cache' })
    ...
    .then(newsItems => {
      ...
      // Only show the latest 3 items on index page
      const latestNews = validNews.slice(0, 3);
